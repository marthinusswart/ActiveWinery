...
namespace ActiveWinery.Administration.ViewModels
{
    public class GroupingViewModel : IViewModel, INotifyPropertyChanged
    {
        ...
        public GroupingViewModel(IWindowsManager windowsManager)
        {
            _windowsManager = windowsManager;
            PropertyChanged += (s, e) => { };

            Groups.Add(new Group() { Name = "Dummy" });
        }
